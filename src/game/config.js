export const GAME_CONFIG = {
  ...
  storm: {
    ...
    fadeInSpeed: 3.6,
    fadeOutSpeed: 2,
    minStrikeInterval: 2.8,
    maxStrikeInterval: 6.4,
    telegraphSeconds: 1,
    strikeSeconds: 0.18,
    scorchSeconds: 0.34,
    strikeRadius: 18,
    strikePenalty: 650,
    disruptionSeconds: 1.6,
    disruptionStrength: 0.45,
    altitudeSafeStart: 0.32,
    altitudeDangerStart: 0.58,
    maxSimultaneousZones: 2,
    rainParticleCount: 220,
    boltPoolSize: 4,
  },
};
